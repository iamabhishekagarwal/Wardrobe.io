            ...
            {maxItems.maxTop ? (
              <div className="text-center">
                ...
                <div className="h-64 flex justify-center">
                  <img
                    src={import.meta.env.IMAGE_API+maxItems.maxTop.imageUrl}
          ...
          <div className="bg-white p-8 shadow-lg rounded-lg hover:shadow-xl transition-all duration-300 ease-in-out">
            ...
            {maxItems.maxBottom ? (
              <div className="text-center">
                ...
                <div className="h-64 flex justify-center">
                  <img
                    src={import.meta.env.IMAGE_API+maxItems.maxBottom.imageUrl}
          ...
          <div className="bg-white p-8 shadow-lg rounded-lg hover:shadow-xl transition-all duration-300 ease-in-out">
            ...
            {maxItems.maxShoes ? (
              <div className="text-center">
                ...
                <div className="h-64 flex justify-center">
                  <img
                    src={import.meta.env.IMAGE_API+maxItems.maxShoes.imageUrl}
          ...
          <div className="bg-white p-8 shadow-lg rounded-lg hover:shadow-xl transition-all duration-300 ease-in-out">
            ...
            {minItems.minTop ? (
              <div className="text-center">
                ...
                <div className="h-64 flex justify-center">
                  <img
                    src={import.meta.env.IMAGE_API+minItems.minTop.imageUrl}
          ...
          <div className="bg-white p-8 shadow-lg rounded-lg hover:shadow-xl transition-all duration-300 ease-in-out">
            ...
            {minItems.minBottom ? (
              <div className="text-center">
                ...
                <div className="h-64 flex justify-center">
                  <img
                    src={import.meta.env.IMAGE_API+minItems.minBottom.imageUrl}
          ...
          <div className="bg-white p-8 shadow-lg rounded-lg hover:shadow-xl transition-all duration-300 ease-in-out">
            ...
            {minItems.minShoes ? (
              <div className="text-center">
                ...
                <div className="h-64 flex justify-center">
                  <img
                    src={import.meta.env.IMAGE_API+minItems.minShoes.imageUrl}
